...
# kernel_sources output-mount candidates -- untested pattern, diagnostic below
# will reveal the real one if neither guess matches.
DATA_CANDIDATES = (
...
run(
    ...
    num_classes=4,
    epochs=30,
    out_dir="/kaggle/working/exp_b_xbd_severity_focal",
    use_focal_loss=True,
)
