...
print(f"using code_root={code_root}, xbd_root={xbd_root}, shard {SHARD_INDEX} of {SHARD_COUNT}")
...
n = run(
    xbd_root,
    "/kaggle/working/xbd_full_bitemporal_patches_shard0",
    all_disasters=True,
    include_pre_disaster=True,
    shard_index=SHARD_INDEX,
    shard_count=SHARD_COUNT,
)
print(f"Experiment F preprocessing shard 0 done: {n} bitemporal building pairs written.")
